...
class Config(object):
    ...
    SAVIOR_STRING = os.environ.get("SAVIOR_STRING", None)
    ...
    # set this with required savior repo link
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/TheSaVior/SAVIOR.git"
    )
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "SaViorX")
    ...
    # Google Drive plugin https://telegra.ph/G-Drive-guide-for-SaViorX-01-01
