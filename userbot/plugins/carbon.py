...
async def carbon_api(event):
    ...
    savior = await eor(event, "`Carbonizing...\n25%`")
    ...
    await savior.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await savior.edit("`Uploading..`")
...
async def carbon_api(event):
    ...
    await SAVIOR.edit("`Meking Carbon...`\n`25%`")
    url = CARBON.format(code=code, lang=CARBONLANG)
    chrome_options = Options()
    chrome_options.add_argument("--headless")
    chrome_options.binary_location = Config.CHROME_BIN
...
async def carbon_api(event):
    ...
    await savior.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await savior.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await event.client.send_file(
        event.chat_id,
        file,
        force_document=True,
...
async def carbon_api(event):
    ...
    await savior.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await savior.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await savior.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await savior.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await savior.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await savior.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await savior.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await savior.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await event.client.send_file(
        event.chat_id,
        file,
