...
async def _(event):
    redeye = await eor(event, "Hmm.. Reply To Husbando Pic")
    ...
    if event.reply_to_msg_id:
        ...
        await redeye.edit(OUTPUT_STR, parse_mode="HTML", link_preview=False)
...
async def _(event):
    savior = await eor(event, "Fetching Auto Husbando chats...")
    all_grp = get_all_grp()
