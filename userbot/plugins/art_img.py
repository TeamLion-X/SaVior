...
from . import _saviortools, convert_toimage, savior, mention, reply_id
...
async def bad(event):
    ...
    if not os.path.isdir("./temp"):
        os.mkdir("./temp")
    output_file = os.path.join("./temp", "SaVior.jpg")
    output = await _saviortools.media_to_pic(event, reply_message)
    outputt = convert_toimage(output[1], filename="./temp/SaVior.jpg")
